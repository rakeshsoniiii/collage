...
try:
    esp32 = serial.Serial('COM3', 115200, timeout=1)  # Change COM3 to your ESP32's port
...
class FaceRecognitionApp:
    ...
    def show_door_open_page(self):
        ...
        # Send command to ESP32 to unlock door
        send_to_esp32("UNLOCK")
    ...
    def lock_door(self):
        if self.door_status == "UNLOCKED":
            self.door_status = "LOCKED"
            # Send command to ESP32 to lock door
            send_to_esp32("LOCK")
    ...
    def send_alert_email(self, image_path=None):
        ...
        FROM_EMAIL = "rakeshsoni9367@gmail.com"
        TO_EMAIL = "rakeshsoni48128@gmail.com"
        APP_PASSWORD = "rlrg vuju ifnb hysb"  # 16-char app password from Google
